  ...
  const handleSearch = async (e) => {
    ...
    try {
      ...
      const response = await axios.get(
        `${API_URL}/api/video/search/tags?query=${encodeURIComponent(
          searchQuery
        )}`
      );
                ...
                <div className="absolute inset-y-0 left-4 flex items-center pointer-events-none">
                  ...
                  >
                    <path
                      ...
                      strokeWidth={2}
                      d="M7 7h.01M7 3h5c.512 0 1.024.195 1.414.586l5 5c.39.39.586.902.586 1.414v5m2 2H7a2 2 0 01-2-2V7a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z"
                    />
                  </svg>
                </div>
                <input

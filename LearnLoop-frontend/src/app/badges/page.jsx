    ...
    <div className="min-h-screen bg-gradient-to-br from-gray-50 to-gray-100 dark:from-gray-900 dark:to-gray-800">
      ...
      <div className="container mx-auto max-w-7xl px-4 py-12">
        ...
        <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center mb-8 gap-4">
          <div className="inline-flex rounded-xl shadow-lg bg-white/80 dark:bg-gray-800/80 backdrop-blur-sm p-1" role="group">
            <button
              type="button"
        ...
        {filteredBadges.length === 0 ? (
          <div className="bg-white/80 dark:bg-gray-800/80 backdrop-blur-sm rounded-xl shadow-xl p-8 text-center border border-gray-200/50 dark:border-gray-700/50">
            ...
            <h3 className="text-2xl font-bold text-gray-900 dark:text-gray-100 mb-3">No Badges Found</h3>
              ...
              return (
                ...
                >
                  <div className={`p-6 flex flex-col items-center text-center ${
                    ...
                    <div className={`text-6xl mb-5 transform transition-all duration-300 ${
                      badge.earned ? 'hover:scale-110' : 'grayscale hover:grayscale-0'
                    }`}>
                      {badge.iconUrl}
                    </div>

...
function SortableVideoItem({
  ...
  return (
    <div ref={setNodeRef} style={style} className="relative" {...attributes}>
      <div
        className="absolute top-2 left-2 z-10 cursor-grab bg-white dark:bg-gray-800 p-2 rounded-full shadow-md"
        {...listeners}
      >
        <svg
    ...
    <div className="relative">
      <div className="mb-4 bg-amber-50 dark:bg-amber-900/20 border-l-4 border-amber-500 p-4 rounded">
        ...
        <p className="text-sm text-amber-700 dark:text-amber-400 mt-1">
          Drag and drop videos to reorder them. The new order will be saved
          automatically.
        </p>
      </div>

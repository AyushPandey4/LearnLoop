...
export default function Sidebar({ 
  ...
  return (
    <div className="w-full md:w-64 bg-gray-800 rounded-lg shadow-md mb-6 md:mb-0 flex flex-col">
      {/* Header Section */}
      ...
      <div className="p-4">
        <div className="flex justify-between items-center mb-3">
          ...
          <button 
            ...
            className="p-1.5 rounded-full bg-gray-700 text-blue-400 hover:bg-gray-600 transition-colors"
          >
        ...
        {showDeleteConfirmation && (
          <div className="mb-4 bg-red-900/20 p-3 rounded-md border border-red-800">
          ...
          {categories.map((category) => (
            <li key={category} className="relative">
              ...
              {categoryMenuOpen === category && (
                <div className="absolute right-1 mt-1 w-36 bg-gray-800 shadow-lg rounded-md z-10 border border-gray-700">
                  <button
                    onClick={() => {
                    ...
                    className="w-full text-left px-3 py-2 text-sm text-gray-300 hover:bg-gray-700 rounded-t-md"
                  >
                    Rename
                  </button>
                  <button
      ...
      <div className="mt-auto p-4 border-t border-gray-700">
        <button
          ...
          className="w-full flex items-center justify-between p-2 rounded-md transition-colors hover:bg-gray-700 text-gray-200"
        >
          <div className="flex items-center">

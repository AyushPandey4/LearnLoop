      ...
      <div className="text-center py-16 bg-gray-800/50 rounded-xl backdrop-blur-sm border border-gray-700/50 transition-all duration-300">
        <div className="transform hover:scale-105 transition-transform duration-300">
          <svg
            ...
            strokeWidth={1.5}
            stroke="currentColor"
            className="w-20 h-20 mx-auto text-gray-500 mb-6"
          >
            <path
              strokeLinecap="round"
        ...
        <p className="text-gray-400 max-w-md mx-auto mb-8">
          You haven't added any playlists yet. Click the "Add Playlist" button
          to get started.
        </p>
        <button
          onClick={() =>
            window.dispatchEvent(new CustomEvent("open-add-playlist"))
          }
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
        {playlists.map((playlist) => {
          const playlistId =
            playlist.id ||
            playlist._id ||
            `playlist-${playlist.name}-${Math.random()
              .toString(36)
              .substring(2, 9)}`;
              ...
              <div className="p-5 space-y-4">
                ...
                <div className="grid grid-cols-3 gap-4">
                  ...
                  <div className="flex flex-col items-center p-2 rounded-lg bg-gray-700/30 hover:bg-gray-700/50 transition-colors duration-300">
                    ...
                    <span className="text-sm text-gray-300">
                      {playlist.rewatchCount || 0} rewatch
                    </span>
                  </div>
                </div>
                ...
                <div className="flex gap-3 pt-2">
                  ...
                  >
                    <svg
                      xmlns="http://www.w3.org/2000/svg"
                      className="h-5 w-5 transform group-hover/delete:scale-110 transition-transform duration-300"
                      fill="none"
                      viewBox="0 0 24 24"
                      stroke="currentColor"
                    >
